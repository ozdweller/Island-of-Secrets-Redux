...
enum ProjectPaths2 {
    ...
    static func findProjectRoot() -> URL? {
        ...
        //    "Island 2.0/engine", data/ and art/ straight into
        ...
        // 3. Walk up from the current working directory (covers `swift
        ...
        // 5. Last resort: the same well-known default location the
